//Please see https://github.com/espressif/arduino-esp32/issues/619
//Try this: https://github.com/iPAS/esp32-slave-spi
...
void SlaveSPI::begin(gpio_num_t so,gpio_num_t si,gpio_num_t sclk,gpio_num_t ss,size_t len,void(* ext)())
{
  ...
  driver = new spi_slave_transaction_t{t_size * 8 , 0 , heap_caps_malloc(max(t_size,size_t(32)), MALLOC_CAP_DMA), heap_caps_malloc(max(t_size,size_t(32)), MALLOC_CAP_DMA),NULL};
